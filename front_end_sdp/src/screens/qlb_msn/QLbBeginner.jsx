...
const QLbBeginner = () => {
    ...
    const handleSubmit = async () => {
        ...
        const result = await Auth.QLbBeginnerAns(qn1, qn2, qn3, game_type, game_name);
        try{
    ...
    const questions = [
        {
            question: "At what blackbody temperature is yellow visible?",
            options: [4000, 5050, 6000, 7000],
            correctAnswer: 5050,
        },
        {
            question: "At what blackbody temperature is blue visible?",
            options: [4000, 5050, 6000, 6500],
            correctAnswer: 6500,
        },
        {
            question: "At what blackbody temperature is red visible?",
            options: [4100, 5050, 6000, 7000],
            correctAnswer: 4100,
        }
    ];
